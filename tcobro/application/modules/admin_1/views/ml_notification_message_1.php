 ...
 <div class="col-md-3">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            <input id="compromiso_pago_date" class="form-control datepicker" onkeydown="return false" data-date-autoclose="true" type="text" name="compromiso_pago_date"  value=""  placeholder="Compromiso Pago" /> 
            <script type="text/javascript">
                $(function () {                 
                $('#compromiso_pago_date').datepicker({
                clearBtn: true,
                todayBtn: true,
                format: 'yyyy-mm-dd'
                });
                $('#compromiso_pago_date').datepicker('setStartDate', new Date());
                 });
            </script>
        </div>
