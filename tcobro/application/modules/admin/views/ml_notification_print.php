      ...
      .pagenum:before { content: counter(page); }
			...
			$oficina_company=new gestcobra\oficina_company_model($credit_detail->oficina_company_id);
				    ...
				    $OFICIAL= $this->user->firstname;
                        ...
                        ?>
                        <img width="80" height="60" src="C:\xampp\htdocs\coac_nueva_fuerza_alianza\uploads\18\logo\logn.png">
...
<th class=3 rowspan=2 WIDTH=140>Direccion</th>
<th class=3 rowspan=2 WIDTH=50>Telefono</th>
<th class=3 rowspan=2 WIDTH=180>Observacion </th>
