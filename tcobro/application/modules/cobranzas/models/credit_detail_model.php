...
class Credit_detail_model extends \CI_Model {
    ...
    private function _get_credit_detail_filter( $filter = null, $client_id, $compromiso_pago_date ) {
            ...
            */
            if( $this->user->role_id == 1 ){
			  ...
			  $this -> db -> where ('c_d.credit_status_id !=', 14);
     ...
     */
        ...
        public function get_credit_detail_count( $filter = null, $client_id, $compromiso_pago_date ) {  
            $this->_get_credit_detail_filter($filter, $client_id, $client_id, $compromiso_pago_date);
