...
if ($show_export == 1) {
    ...
    <form method="post" action="<?= base_url('admin/notificationformat/notification_print/0') ?>" class="form-horizontal">
        ...
        <div class="form-group">
            <button type="button" id="autosubmit" class="btn btn-primary pull-right" name="notification_id" value="com_masiva" style="font-size: 15px"><i class="icon-ok"></i>&nbsp;NOTIFICAR</button>            
        </div>
        ...
        <table id="table_credits_f" 
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th data-field="client_code" data-filter-control="input">Nro. Cliente</th>
