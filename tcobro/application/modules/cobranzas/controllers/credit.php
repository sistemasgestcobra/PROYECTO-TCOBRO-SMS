        ...
        */
            ...
            $credit_detail->fecha_ultima_gestion= date('Y-m-d', time());
                ...
                if ( ! $credit_detail->is_valid() ){
					...
					if ($detalle == "ac" || $detalle == "AC" || $detalle == "undefined" || $detalle == "") {
						...
						//$this->_save_div($credit_detail->id);
		 $this->ws_send_sms_call();					
					$this->_save_contact($credit_detail);
        ...
        private function _save_credit_hist($credit_detail_id) {
			...
			$credito = (new gestcobra\credit_detail_model())
                    ...
                    ->find_one();
			$alertas->numero_operacion= $credito->nro_pagare;
            ...
            if($contacto_seleccionado && $message){
				...
				$credit_detail= (new gestcobra\credit_detail_model($credit_detail_id));
				 ...
				 $DEUDOR_NAME=substr($DEUDOR_NAME, 11);
					...
					$TOTAL_PAGO=$credit_detail->total_pagar;
					...
					$mensaje_aux = str_replace('TOTAL_PAGO', $TOTAL_PAGO, $mensaje_aux);
			   ...
			   //print_r($message);
					  ...
					  $obj_commws->http_conn_comunication_cd($message);
						...
						print_r("Envio de SMS" .$mensaje_aux);
