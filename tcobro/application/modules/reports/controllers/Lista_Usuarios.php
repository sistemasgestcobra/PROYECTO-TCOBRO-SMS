...
function __construct() {
	...
	public function index()
	{
       ...
       // $oficina = 390;
        if (!$mysqli->multi_query("select of.cedula, of.firstname, of.email, r.role_name, oc.name, of.status_ac from oficial_credito of, role r, oficina_company oc where r.id=of.role_id and oc.id=of.oficina_company_id group by of.id desc")) 
...
$objActSheet->getColumnDimension('F')->setAutoSize(true);
        ...
        $this->excel->setActiveSheetIndex(0)
                ...
                ->setCellValue('C1', 'Usuario/e-mail  ')
                ->setCellValue('D1', 'Rol    ')
                ->setCellValue('E1', 'Oficina   ')
        ...
        $fecha=date('Y/M/d');
        $nombre='ListaUusarios-'."$fecha".'.xlsx';
