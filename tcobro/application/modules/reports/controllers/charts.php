...
////		$serie['series'] = array('ENERO', 'FEBRERO', 'MARZO', 'ABRIL', 'MAYO', 'JUNIO');
//		
//		$serie['data']	= array(
//			array( 'enero', 20 ), 
//			array( 'febrero', 15 ), 
//			array( 'marzo', 60 )
//		);                
//                $this->highcharts->set_axis_titles('TITULO HORIZONTAL', 'TITULO VERTICAL');
//                
//                
//                
////                $this->highcharts->set_dimensions('300', '300');
//                $this->highcharts->set_title($html_tile, 'Oficial: Esteban Chamba');
//                $graph_data['axis']['categories'] = array('English', 'Chinese', 'Spanish');
...
//                
//		$data['charts'] = $this->highcharts->set_serie($serie, 'MESES')->render();
//		
