...
//                array( 'report_comunicaciones_fecha', 'Comunicaciones por fecha', array('comparar'=>'0') ),
    ...
    public function report_by_oficial() {
        ...
        $res['menu'] = array(
			...
			array('Gestiones por Oficial', 'icon-apple'),
//                    array( 'Comparativa de Gestiones por Oficial', 'icon-apple')
        ...
        $res['content_menu'] = array(
			...
			array('report_gestiones_oficial', 'Reporte de Gestiones por Oficial', array('comparar' => '1', 'oficiales_credito' => $oficiales_credito, 'oficiales_gestion' => $oficiales_gestiones)),
