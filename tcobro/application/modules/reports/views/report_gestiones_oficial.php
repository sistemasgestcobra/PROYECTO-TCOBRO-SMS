...
<form method="post" action="<?= base_url('reports/reportes/open_view_gestiones')?>" class="form-horizontal">
...
<div class="form-group col-md-4">
  <label class="col-md-4 control-label" for="from_date">Fecha</label>  
  <div class="col-md-8">
...
<!-- Button -->
<div class="form-group col-md-2">
      <button reset-form="0" name="type_group" value="1" id="autosubmit" data-target="#chart_gestiones" class="btn btn-primary">Ver Tabla</button>
