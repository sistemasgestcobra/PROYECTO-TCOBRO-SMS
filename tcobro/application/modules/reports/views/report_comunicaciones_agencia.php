...
<div class="form-group col-md-1">
      <button reset-form="0" name="type_group" value="1" id="autosubmit_1" data-target="#chart_comunicationes_agencia" class="btn btn-primary">Graficar</button>
</div>
