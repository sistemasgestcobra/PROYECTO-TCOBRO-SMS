...
//                                            ->count();
                if ($credit_status->id > 0) {
                    ...
                    $this->db->where('c_h.credit_status_id', $credit_status->id);
                    //$this->db->having('c_d.id=c_h.credit_detail_id');
...
//                      echo $this->user->id;
            ...
            if ($this->user->role_id == 3 OR $this->user->role_id == 100) {
                ?>
                <li>
                    <a class="current" href="<?= base_url('companyadmin.jsp') ?>"><span aria-hidden="true" class="icon-gears"></span>Administraci&oacute;n</a>
                </li>
