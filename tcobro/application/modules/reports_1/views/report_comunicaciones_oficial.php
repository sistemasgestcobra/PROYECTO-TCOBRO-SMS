<form method="post" action="<?= base_url('reports/oficialcomunicationscharts/get_chart_comunication_by_oficial')?>" class="form-horizontal">
...
//$fechas=$this->db->query("select firstname from oficial_credito where oficina_company_id=6");
//$lol=$fechas->result();
...
<!-- Button -->
<div class="form-group col-md-2">
      <button reset-form="0" name="type_group" value="1" id="autosubmit" data-target="#chart_oficial_creditos_oficial" class="btn btn-primary">Graficar</button>
</div>
</fieldset>
</form>
<div id="chart_oficial_creditos_oficial">
</div>