               ...
               <?php
                                $path_profile_image = './uploads/user/'.$this->user->id.'/profile_image/'.$this->user->profile_image;
                                    if (file_exists($path_profile_image)) {
                                        ?>
                                        <img class="img-circle img-responsive center-block" style="width: 300px; height: 300px; margin: 0 auto" src="<?= base_url('uploads/user/'.$this->user->id.'/profile_image/ccl.png') ?>" />
                                        <?php
                                    }else{
                                        ?>
