...
class Contactos_model extends \CI_Model {
            ...
            if($filter){
                foreach ($filter as $key => $value) {
                    ...
                    if($key == 'numero'){
                        ...
                        $this -> db -> like ('UPPER(c.apellido)', strtoupper($value));                        
     ...
     */
     ...
     //   $this -> db -> from('contact_grupo c');
            ...
            $this -> db -> select(
                        'c.id, c.id_grupo,c.numero, c.nombre, c.apellido,c.variable1,c.variable2,c.variable3,c.variable4',FALSE
                    );
...
//          echo $this->db->last_query();
        ...
        public function get_oficina_company_count($filter = null,$id_grupo) {  
            $this->_get_oficina_company_filter( $id_grupo,$filter);
