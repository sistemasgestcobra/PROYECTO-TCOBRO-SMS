<form method="post" action="<?= base_url('msjs/oficinacompany_1/save')?>" class="form-horizontal">
    ...
    <div id="toolbar">
        ...
        <table id="table_bases"
              ...
              data-toggle="table"
               ...
               data-url="<?= base_url('msjs/bases/get_bases_report') ?>"
               data-sort-name="id"
        ...
        >
            ...
            <tr>
                ...
                <th data-field="observaciones"  data-formatter="formatDireccion" data-filter-control="input">Observaciones</th>
...
//                    price: '$'
    ...
    function editCompany( index, row ) {
        ...
        var openDoc = '<a id="call-php" class="" href="#" data-target="messagesout" php-function="<?= base_url() ?>modal/msjs__bases__open_contactos__'+id+'/0/0">Ver Contactos</a>';
          html.push(openDoc);
        return html.join('');        
    }
