...
<!--                            <div class="fileupload fileupload-new" data-provides="fileupload">
                            <input type="file" value="" name="logo">
                                <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                    <img src="<?php // echo './uploads/'.$ml_company_model->id.'/logo/'.$ml_company_model->logo ?>">
                                </div>
                            ...
                            <div>
                                ...
                                <a class="btn btn-default fileupload-exists" href="#" data-dismiss="fileupload">Remove</a>
                            </div>
                        </div>-->
                    </div>            
                </div>               
