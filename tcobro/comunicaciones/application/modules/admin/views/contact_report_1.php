...
<form method="post" action="<?= base_url('admin/credit/save') ?>" class="form-horizontal">
    ...
    <div class="handsontable" id="example">
        ...
        <button class="btn btn-default btn-xs" type="submit" id="autosubmit" data-table-name="table_contact">Guardar Cambios</button>  
        ...
        <table id="table_contact"
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th data-field="nombre" data-sortable='true' data-formatter="formatName" >Nombres</th>
                    <!--<th data-field="lastname" data-formatter="inputFormatterLastname" data-filter-control="input">Apellidos</th>-->
                    <th data-field="observaciones"  data-formatter="inputFormatterContactValue" data-filter-control="input">Telefono</th>
