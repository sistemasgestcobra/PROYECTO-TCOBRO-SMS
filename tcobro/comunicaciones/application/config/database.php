...
$db['gestcobra']['username'] = "utpl_usuario";
$db['gestcobra']['password'] = "@tcobro@1";
//$db['gestcobra']['database'] = "gestcobrapru";
$db['gestcobra']['database'] = "utpl_sms";

// The following values can probably stay the same.
$db['gestcobra']['hostname'] = "utpl.gestcobra.com";
$db['gestcobra']['dbdriver'] = "mysql";
$db['gestcobra']['dbprefix'] = "";
$db['gestcobra']['pconnect'] = TRUE;
$db['gestcobra']['db_debug'] = FALSE;
