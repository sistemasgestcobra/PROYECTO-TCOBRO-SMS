...
<?php
    ...
    ?>    
      ...
      <div class="col-md-12 hidden-xs">
          ...
          <div class="col-md-8">
            <img style="width: 100%; height:400px" src="<?= base_url('assets/images/slider/sms.jpg')?>" />
          </div>      
        <div class="col-md-4">
        <?php
               ...
               <?php
                                $path_profile_image = './uploads/user/'.$this->user->id.'/profile_image/'.$this->user->profile_image;
                                    if (file_exists($path_profile_image)) {
                                        ?>
                                        <img class="img-circle img-responsive center-block" style="width: 300px; height: 300px; margin: 0 auto" src="<?= base_url('uploads/user/'.$this->user->id.'/profile_image/logo.jpg') ?>" />
                                        <?php
                                    }else{
                                        ?>
