    ...
    <strong class="text-primary">Historial de Notificaciones:</strong>            
            <table id="table_credit_hist_notification<?= $show_export ?>" class="table-condensed"
                   data-side-pagination="server"
                   data-pagination="true"                  
                   data-toggle="table_credits_hist_notification"
                   data-height="<?php echo $data_height ?>"
                   data-url="<?= base_url('admin/creditstatus/get_hist_notification_report/'.$client_id.'/'.$compromiso_pago_date) ?>"
                   data-sort-name="id"
...
<!--                    <th data-field="contact-id" data-filter-control="input">Id Contacto</th>-->
                ...
                <?php
                    ...
                    <th data-field="client_name" data-formatter="inputFormatterClientName" data-filter-control="input">Cliente</th>                    
                ...
                ?>  
                    ...
                    <th data-field="contact_id" data-filter-control="input">Numero Contactado</th>
                    <th data-field="valor_promesa" data-filter-control="input">Valor Promesa</th>
                </tr>
                </thead>
            </table>            
        </div>        
...
<script>
        $('[data-toggle="table_credits_hist_notification"]').bootstrapTable();
    
       function inputFormatterDetailHist(index, row) {
           var detail = row['detail'];
           var inputDetail = "<input type='text' rel='txtTooltip' data-toggle='tooltip' data-placement='bottom' title='"+detail+"' style='min-width:200px' class='' name='detail_hist_notification' value='"+detail+"'/> ";
           return inputDetail;
       }
