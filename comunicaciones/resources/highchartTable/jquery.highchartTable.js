...
(function($) {
  $.fn.highchartTable = function() {
    ...
    this.each(function() {
      ...
      /**
       * 
       * @type @exp;$table@call;data25/02/2016 by Esteban Chamba, se agrega para obtener un encabezado que
       * podra imprimirse junto al grafico estadistico
       */
      var headContainerId = $table.data('head-text');
      var headText = $(headContainerId).html();
