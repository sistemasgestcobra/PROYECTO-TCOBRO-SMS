    ...
    <div id="toolbar">
        ...
        <table id="table_bases"
              ...
              data-toggle="table"
               ...
               data-url="<?= base_url('admin/oficinacompany_1/get_oficina_company_report') ?>"
               data-sort-name="id"
...
//                    price: '$'
    ...
    function editCompany( index, row ) {
        ...
        var openDoc = '<a id="call-php" class="" href="#" data-target="messagesout" php-function="<?= base_url() ?>modal/admin__oficinacompany_1__open_contactos__'+id+'/0/0">Ver Contactos</a>';
          html.push(openDoc);
        return html.join('');        
    }
