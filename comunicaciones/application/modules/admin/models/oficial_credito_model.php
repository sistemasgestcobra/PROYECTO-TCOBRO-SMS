...
class Oficial_credito_model extends \CI_Model {
     ...
     */
        function get_oficial_credito_data( $limit, $offset, $filter = null, $order_by = null ) {
            ...
            $this -> db -> select(
                        'o_cred.id, o_cred.cedula, o_cred.firstname, o_cred.lastname, o_cred.email, o_cred.telefono, o_c.name oficina_name, r.role_name, o_cred.role_id, o_cred.oficina_company_id,o_cred.status,o_cred.status_ac'
                    );
