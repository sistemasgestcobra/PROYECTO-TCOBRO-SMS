...
//        $base_nombre=  set_post_value('name');
        ...
        if (file_exists($logo_path . $upl_data['file_name'])) {
            ...
            for ($x = 2; $x <= $PHPExcel->getActiveSheet()->getHighestRow(); $x++) {
                ...
                $apellido=get_value_xls($PHPExcel, $this->abecedario["C"], $x);
                $variable1=get_value_xls($PHPExcel, $this->abecedario["D"], $x);
                $variable2=get_value_xls($PHPExcel, $this->abecedario["E"], $x);
                $variable3=get_value_xls($PHPExcel, $this->abecedario["F"], $x);
                $variable4=get_value_xls($PHPExcel, $this->abecedario["G"], $x);
