...
class credit_detail_model extends \Orm_model {
	...
	public static $fields = array(
		...
		array('name' => 'adjudicacion_date', 'type' => 'string', 'allow_null' => true),
		array('name' => 'credito_type_id', 'type' => 'int'),
		array('name' => 'curr_date', 'type' => 'date', 'date_format' => 'Y-m-d'),
		array('name' => 'cuotas_pagadas', 'type' => 'float', 'allow_null' => true),
		...
		array('name' => 'oficina_company_id', 'type' => 'int'),
                array('name' => 'total_abono', 'type' => 'float'),
                array('name' => 'fecha_limite', 'type' => 'date', 'date_format' => 'Y-m-d', 'allow_null' => true),
                array('name' => 'mora_actual', 'type' => 'int', 'allow_null' => true),
                ...
                array('name' => 'saldo_capital', 'type' => 'float', 'allow_null' => true),
                array('name' => 'nivel_cartera', 'type' => 'string', 'allow_null' => true),
                array('name' => 'estado_cuenta', 'type' => 'string', 'allow_null' => true)
