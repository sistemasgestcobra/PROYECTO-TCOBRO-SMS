...
$config['base_url']	= '//'.$_SERVER['HTTP_HOST'].'/'.$main_directory;
...
|
*/
$config['sess_cookie_name']		= 'gest_sess';
...
$config['csrf_token_name'] = 'csrf_ml1';
$config['csrf_cookie_name'] = 'csrf_cookml1';
