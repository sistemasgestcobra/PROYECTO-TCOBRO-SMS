...
//    const http_xml_url = 'https://api.nexmo.com/tts/xml';
//    const http_json_url = 'https://api.nexmo.com/tts/json';

/**
 * Por defecto la URL es para SMS
 */
    private $http_xml_url = 'https://rest.nexmo.com/sms/xml';
    private $http_json_url = 'https://rest.nexmo.com/sms/json';    
    
    /**
     * $reference puede ser : sms or voice
     * @var type 
     */
    private $_reference = 'sms';
...
//        $url = ($this->_format === 'json') ? self::http_json_url : self::http_xml_url;
        ...
        if($this->_format === 'json'){
            $url = $this->http_json_url;
        }else{
            $url = $this->http_xml_url;
        }
    ...
    /**
     * Set reference. may be : sms or voice
     * @param type $reference
     * @return \Nexmo
     */
    public function set_reference($reference = 'sms')
    {
        $this->_reference = $reference;

        if($reference == 'voice'){
            $this->http_xml_url = 'https://api.nexmo.com/tts/xml';
            $this->http_json_url = 'https://api.nexmo.com/tts/json';            
        }
        return $this;
    }
