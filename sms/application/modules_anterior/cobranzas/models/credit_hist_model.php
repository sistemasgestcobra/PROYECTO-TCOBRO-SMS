...
class Credit_hist_model extends \CI_Model {
    private function _get_hist_filter( $filter = null, $client_id, $compromiso_pago_date ) {
            ...
            $this -> db -> join('comision_cobranzas c_c', 'c_c.id = c_h.comision_id');
