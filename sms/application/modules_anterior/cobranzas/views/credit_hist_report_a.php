    ...
    <strong class="text-primary">Historial:</strong>            
            <table id="table_credit_hist<?= $show_export ?>" class="table-condensed"
                   ...
                   data-url="<?= base_url('cobranzas/credit/get_hist_report_a/'.$client_id.'/'.$compromiso_pago_date.'/'.$var) ?>"
                   data-sort-name="id"
            ...
            >
                ...
                ?>
					...
					<th data-field="firstname" data-sortable="true" data-filter-control="input">Gestor</th>
					<th data-field="propietario" data-sortable="true" data-filter-control="input">Oficical</th>
