...
//                    );
            $this -> db -> select(
                        'c_d.id, c_d.nro_cuotas, c_d.nro_pagare, c_d.deuda_inicial, c_d.saldo_actual, c_d.curr_date, c_d.adjudicacion_date, c_d.total_cuotas_vencidas, o_c.id oficial_credito_id, o_c.firstname oficial_credito, c_d.updated_month_id, c_d.updated_year, m.month_name, o_comp.name agencia_name, c_d.oficina_company_id,com.id,com.type,c_r.credit_detail_id,com.status,com.cost,com.contact,com.curr_date,com.curr_time,com.user_id,com.network,com.comunication_type_id,com.client_referencias_id'
                    );
            if($search_type == 'date'){
                if($type_group == 1){
