...
class Client_referencias_contact_model extends \CI_Model {
    ...
    function get_data($limit, $offset, $filter = null, $order_by = null, $client_id) {
        ...
        $this->db->select(
                'c.id, c.id contact_id, c.contact_value, c.description, c.person_id, c.contact_type_id, c.contact_respuesta_id, CONCAT_WS("", pr.firstname, " ",pr.lastname) client_name, c.person_id ,c_t.contact_name ', FALSE
        );
