...
<div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <!-- Text input-->
 <button reset-form="0" name="type_group" value="1" id="autosubmit" data-target="#chart_recuperacion_oficial" class="btn btn-primary">Graficar</button>
...
<div id="chart_recuperacion_oficial">
