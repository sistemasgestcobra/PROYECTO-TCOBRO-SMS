...
//grafica comparativa actual
  ...
  public function open_graf_produccion() {
        ...
        $this->load->view('view_graficos/grafica_produccionGestiones.php');
    }		public function open_graf_producto() {      
	$this->load->view('view_graficos/grafica_producto.php');    
	}	
	public function open_graf_producto_oficial() {        
	$this->load->view('view_graficos/grafica_producto_oficial.php');    
	}
}
