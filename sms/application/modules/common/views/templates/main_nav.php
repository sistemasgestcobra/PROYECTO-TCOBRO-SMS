...
//                      echo $this->user->id;
				...
				<li>
                    <a class="current"  href="<?= base_url('/uploads/18/MANUAL_TCOBRO.pdf')?>" target="blank"><span aria-hidden="true" class="glyphicon glyphicon-book"></span>MANUAL</a>
                </li>
                <li>
...
function alerta() {
        ...
        xmlhttp.open("GET","/emigrante/uploads/alerta.php?q="+a,true);
        xmlhttp.send();
}
