...
$sql = "select r.oficial_name, (r.cantidad_creditos+ r.aux_cant) as aux1, (r.capital+r.aux_capit), r.cantidad_recuperada, r.capital_recuperado,
IfNULL(round((r.cantidad_recuperada*100/(r.cantidad_creditos)),2),0) as total
...
<br>
 <div class="col-md-15 text-center">
      <a id="call-php" class="btn btn-success btn-xs" href="#" data-target="messagesout" php-function="<?= base_url() ?>modal/reports__reportes__open_view3__/0/0">MOSTRAR GRAFICA</a>
</div>
