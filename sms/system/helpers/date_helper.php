...
function date_add_days($givendate,$day=0,$mth=0,$yr=0)
{
...
function date_diff_date($start_date,$end_date,$format = 'd')
{
...
function get_date_timezone($timezone = 'America/New_York', $full_date_time = false)
{
